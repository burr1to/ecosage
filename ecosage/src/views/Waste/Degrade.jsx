        ...
        <div className='mt-[40px] flex gap-x-9'>
          ...
          <div className='flex-auto'>
            <p className='text-justify p-6 text-[18px]'>
              ...
              waste (such as grass clippings, leaves), paper products, and
              certain types of packaging materials made from natural materials
              like starch or cellulose. Unlike non-biodegradable waste, which
              can persist in the environment for long periods without breaking
              down, biodegradable waste can be composted or recycled through
              biological processes, reducing the burden on landfills and
